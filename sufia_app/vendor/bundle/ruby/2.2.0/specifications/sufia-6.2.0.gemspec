...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<sufia-models>, ["= 6.2.0"])
      ...
      s.add_runtime_dependency(%q<tinymce-rails>, ["~> 4.1"])
      ...
      s.add_development_dependency(%q<jasmine>, ["~> 2.3"])
    else
      s.add_dependency(%q<sufia-models>, ["= 6.2.0"])
      ...
      s.add_dependency(%q<jasmine>, ["~> 2.3"])
    end
  else
    s.add_dependency(%q<sufia-models>, ["= 6.2.0"])
    s.add_dependency(%q<blacklight_advanced_search>, ["< 6.0", ">= 5.1.4"])
